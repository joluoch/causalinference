...
from sklearn.metrics import confusion_matrix,precision_score,accuracy_score,recall_score,roc_auc_score,roc_curve


le = LabelEncoder()
y = le.fit_transform(y)

y = pd.Series(data=y, name='diagnosis', index = list(data['id']))
y
